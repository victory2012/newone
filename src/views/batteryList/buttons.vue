  ...
  <div>
    ...
    <el-dialog width="600px" :title="titles" :visible.sync="addModel">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button size="small" @click="resetModelAdd">{{$t('batteryList.cancel')}}</el-button>
        <el-button :loading="addallTypes" size="small" @click="submitModelAdd" type="primary">{{$t('batteryList.sure')}}</el-button>
      </div>
    </el-dialog>
  </div>
</template>
